...
const socialsData: SocialNetworks[] = [
  {
    id: 1,
    icon: <FaTwitter />,
    url: "https://x.com/muhammshahzaib?t=mEKHbHgL_li2jJC0b6JatQ&s=09",
  },
  {
    id: 2,
    icon: <FaFacebookF />,
    url: "https://www.facebook.com/people/Shahzaib-Khan/pfbid0T8rUsh7YLHFWFFWY3T3xZtqaUetauhWxeY9tc91QPr79pazCggitR5rpEV7eGqaJl/?rdid=p9x5J7BGhZKgw4Jz&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2Fg3y3RYPGo7CavPJs%2F",
  },
  {
    id: 3,
    icon: <FaInstagram />,
    url: "https://www.instagram.com/shahzaib.khan18/",
  },
  {
    id: 4,
    icon: <FaGithub />,
    url: "https://github.com/Shahzaib-Khan-200024",
  },
];
        ...
        <div className="max-w-frame mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-between items-center mb-2">
            <p className="text-sm text-center sm:text-left text-black/60 mb-4 sm:mb-0 sm:mr-1">
              Shop.co © Made by {" "}
              <Link
                href="https://github.com/Shahzaib-Khan-200024"
